...
require (
	buf.build/gen/go/mpapenbr/testrepo/connectrpc/go v1.16.0-20240328105213-21f3a2569df2.1
	buf.build/gen/go/mpapenbr/testrepo/protocolbuffers/go v1.33.0-20240328105213-21f3a2569df2.1
