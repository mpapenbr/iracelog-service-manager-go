...
require (
	buf.build/gen/go/mpapenbr/iracelog/connectrpc/go v1.17.0-00000000000000-5387f520969c.1
	buf.build/gen/go/mpapenbr/iracelog/protocolbuffers/go v1.35.2-00000000000000-5387f520969c.1
