...
require (
	buf.build/gen/go/mpapenbr/testrepo/connectrpc/go v1.16.0-20240327152211-1860975e0d22.1
	buf.build/gen/go/mpapenbr/testrepo/protocolbuffers/go v1.33.0-20240327152211-1860975e0d22.1
