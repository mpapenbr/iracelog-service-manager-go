...
require (
	buf.build/gen/go/mpapenbr/testrepo/connectrpc/go v1.16.0-20240327213922-ee48fa5b325c.1
	buf.build/gen/go/mpapenbr/testrepo/protocolbuffers/go v1.33.0-20240327213922-ee48fa5b325c.1
