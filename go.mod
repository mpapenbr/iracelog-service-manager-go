...
require (
	buf.build/gen/go/mpapenbr/iracelog/connectrpc/go v1.17.0-20241122203353-c5c0957a3a46.1
	buf.build/gen/go/mpapenbr/iracelog/protocolbuffers/go v1.35.2-20241122203353-c5c0957a3a46.1
