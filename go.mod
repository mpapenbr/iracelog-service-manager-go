...
require (
	buf.build/gen/go/mpapenbr/iracelog/connectrpc/go v1.17.0-00000000000000-ed6a0bf254c1.1
	buf.build/gen/go/mpapenbr/iracelog/protocolbuffers/go v1.35.2-00000000000000-ed6a0bf254c1.1
