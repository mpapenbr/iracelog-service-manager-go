...
require (
	buf.build/gen/go/mpapenbr/testrepo/connectrpc/go v1.16.0-20240328223601-775253b8ef58.1
	buf.build/gen/go/mpapenbr/testrepo/protocolbuffers/go v1.33.0-20240328223601-775253b8ef58.1
