...
require (
	buf.build/gen/go/mpapenbr/iracelog/connectrpc/go v1.17.0-20241109095545-7996217084b6.1
	buf.build/gen/go/mpapenbr/iracelog/protocolbuffers/go v1.35.1-20241109095545-7996217084b6.1
