...
require (
	buf.build/gen/go/mpapenbr/iracelog/connectrpc/go v1.17.0-00000000000000-0c3a6fad2b18.1
	buf.build/gen/go/mpapenbr/iracelog/protocolbuffers/go v1.35.2-00000000000000-0c3a6fad2b18.1
