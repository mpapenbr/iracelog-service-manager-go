...
var EventExts = psql.NewTablex[*EventExt, EventExtSlice, *EventExtSetter]("", "event_ext")
...
type eventExtColumnNames struct {
	EventID   string
	ExtraInfo string
}

var EventExtColumns = buildEventExtColumns("event_ext")
...
func FindEventExt(ctx context.Context, exec bob.Executor, EventIDPK int32, cols ...string) (*EventExt, error) {
	if len(cols) == 0 {
		return EventExts.Query(
			SelectWhere.EventExts.EventID.EQ(EventIDPK),
		).One(ctx, exec)
	}
...
func (o *EventExt) pkEQ() dialect.Expression {
	return psql.Quote("event_ext", "event_id").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
...
func (o *EventExt) Reload(ctx context.Context, exec bob.Executor) error {
	o2, err := EventExts.Query(
		SelectWhere.EventExts.EventID.EQ(o.EventID),
	).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o EventExtSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("event_ext", "event_id").In(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
	...
	return eventExtPreloader{
		Event: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Event, EventSlice](orm.Relationship{
				...
				Sides: []orm.RelSide{
					{
						From: TableNames.EventExts,
						To:   TableNames.Events,
						FromColumns: []string{
							ColumnNames.EventExts.EventID,
						},
						ToColumns: []string{
