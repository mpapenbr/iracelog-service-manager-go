...
var Events = psql.NewTablex[*Event, EventSlice, *EventSetter]("", "event", buildEventColumns("event"), eventScanMapper)
...
type eventRLoaded struct {
	AnalysisProto bool // analysis_proto.analysis_proto_event_id_fkey
	CCars         bool // c_car.c_car_event_id_fkey
	CCarClasses   bool // c_car_class.c_car_class_event_id_fkey
	CCarEntries   bool // c_car_entry.c_car_entry_event_id_fkey
	Tenant        bool // event.event_tenant_id_fk
	Track         bool // event.event_track_id_fkey
	EventExt      bool // event_ext.event_ext_event_id_fkey
	RSInfos       bool // rs_info.rs_info_event_id_fkey
}
...
func buildEventColumns(tableName string) eventColumns {
	...
	return eventColumns{
		...
		EventKey:             buildEventColumn(tableName, "event_key"),
		Name:                 buildEventColumn(tableName, "name"),
		Description:          buildEventColumn(tableName, "description"),
		EventTime:            buildEventColumn(tableName, "event_time"),
		RaceloggerVersion:    buildEventColumn(tableName, "racelogger_version"),
		TeamRacing:           buildEventColumn(tableName, "team_racing"),
		MultiClass:           buildEventColumn(tableName, "multi_class"),
		NumCarTypes:          buildEventColumn(tableName, "num_car_types"),
		NumCarClasses:        buildEventColumn(tableName, "num_car_classes"),
		IrSessionID:          buildEventColumn(tableName, "ir_session_id"),
		TrackID:              buildEventColumn(tableName, "track_id"),
		PitSpeed:             buildEventColumn(tableName, "pit_speed"),
		ReplayMinTimestamp:   buildEventColumn(tableName, "replay_min_timestamp"),
		ReplayMinSessionTime: buildEventColumn(tableName, "replay_min_session_time"),
		ReplayMaxSessionTime: buildEventColumn(tableName, "replay_max_session_time"),
		Sessions:             buildEventColumn(tableName, "sessions"),
		IrSubSessionID:       buildEventColumn(tableName, "ir_sub_session_id"),
		TenantID:             buildEventColumn(tableName, "tenant_id"),
		TireInfos:            buildEventColumn(tableName, "tire_infos"),
	}
}
...
type eventColumns struct {
	...
	tableAlias           string
	ID                   eventColumn
	EventKey             eventColumn
	Name                 eventColumn
	Description          eventColumn
	EventTime            eventColumn
	RaceloggerVersion    eventColumn
	TeamRacing           eventColumn
	MultiClass           eventColumn
	NumCarTypes          eventColumn
	NumCarClasses        eventColumn
	IrSessionID          eventColumn
	TrackID              eventColumn
	PitSpeed             eventColumn
	ReplayMinTimestamp   eventColumn
	ReplayMinSessionTime eventColumn
	ReplayMaxSessionTime eventColumn
	Sessions             eventColumn
	IrSubSessionID       eventColumn
	TenantID             eventColumn
	TireInfos            eventColumn
}
...
func (s EventSetter) SetColumns() []string {
	...
	if s.IrSessionID.IsValue() || s.IrSessionID.IsNull() {
	...
	if s.TireInfos.IsValue() || s.TireInfos.IsNull() {
...
func (s *EventSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(
		bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			...
			return psql.Arg(s.EventKey.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.Name.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			...
			return psql.Arg(s.EventTime.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.RaceloggerVersion.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.RaceloggerVersion.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.TeamRacing.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.TeamRacing.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.MultiClass.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.MultiClass.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.NumCarTypes.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.NumCarTypes.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.NumCarClasses.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.NumCarClasses.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.IrSessionID.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.IrSessionID.MustGetNull()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.TrackID.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.TrackID.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			...
			return psql.Arg(s.ReplayMinTimestamp.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.ReplayMinSessionTime.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.ReplayMinSessionTime.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.ReplayMaxSessionTime.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.ReplayMaxSessionTime.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.Sessions.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.Sessions.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.IrSubSessionID.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.IrSubSessionID.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.TenantID.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.TenantID.MustGet()).WriteSQL(ctx, w, d, start)
		}), bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
			if s.TireInfos.IsUnset() {
				return psql.Raw("DEFAULT").WriteSQL(ctx, w, d, start)
			}
			return psql.Arg(s.TireInfos.MustGetNull()).WriteSQL(ctx, w, d, start)
		}))
}
...
func eventScanMapper(ctx context.Context, cols []string) (scan.BeforeFunc, func(any) (*Event, error)) {
	...
	for i, col := range cols {
		...
		case "event_key":
			targets = append(targets, target{i, func(o *Event) any { return &o.EventKey }})
		case "name":
			targets = append(targets, target{i, func(o *Event) any { return &o.Name }})
		case "description":
			targets = append(targets, target{i, func(o *Event) any { return &o.Description }})
		case "event_time":
			targets = append(targets, target{i, func(o *Event) any { return &o.EventTime }})
		case "racelogger_version":
			targets = append(targets, target{i, func(o *Event) any { return &o.RaceloggerVersion }})
		case "team_racing":
			targets = append(targets, target{i, func(o *Event) any { return &o.TeamRacing }})
		case "multi_class":
			targets = append(targets, target{i, func(o *Event) any { return &o.MultiClass }})
		case "num_car_types":
			targets = append(targets, target{i, func(o *Event) any { return &o.NumCarTypes }})
		case "num_car_classes":
			targets = append(targets, target{i, func(o *Event) any { return &o.NumCarClasses }})
		case "ir_session_id":
			targets = append(targets, target{i, func(o *Event) any { return &o.IrSessionID }})
		case "track_id":
			targets = append(targets, target{i, func(o *Event) any { return &o.TrackID }})
		case "pit_speed":
			targets = append(targets, target{i, func(o *Event) any { return &o.PitSpeed }})
		case "replay_min_timestamp":
			targets = append(targets, target{i, func(o *Event) any { return &o.ReplayMinTimestamp }})
		case "replay_min_session_time":
			targets = append(targets, target{i, func(o *Event) any { return &o.ReplayMinSessionTime }})
		case "replay_max_session_time":
			targets = append(targets, target{i, func(o *Event) any { return &o.ReplayMaxSessionTime }})
		case "sessions":
			targets = append(targets, target{i, func(o *Event) any { return &o.Sessions }})
		case "ir_sub_session_id":
			targets = append(targets, target{i, func(o *Event) any { return &o.IrSubSessionID }})
		case "tenant_id":
			targets = append(targets, target{i, func(o *Event) any { return &o.TenantID }})
		case "tire_infos":
			targets = append(targets, target{i, func(o *Event) any { return &o.TireInfos }})
		}
	}
...
func (os EventSlice) AnalysisProto(mods ...bob.Mod[*dialect.SelectQuery]) AnalysisProtosQuery {
	...
	return AnalysisProtos.Query(append(mods,
		sm.Where(AnalysisProtos.Columns.EventID.EQ(PKArgExpr)),
	)...)
}
...
func (os EventSlice) CCars(mods ...bob.Mod[*dialect.SelectQuery]) CCarsQuery {
	...
	return CCars.Query(append(mods,
		sm.Where(CCars.Columns.EventID.EQ(PKArgExpr)),
	)...)
}
...
func (os EventSlice) CCarClasses(mods ...bob.Mod[*dialect.SelectQuery]) CCarClassesQuery {
	...
	return CCarClasses.Query(append(mods,
		sm.Where(CCarClasses.Columns.EventID.EQ(PKArgExpr)),
	)...)
}
...
func (os EventSlice) CCarEntries(mods ...bob.Mod[*dialect.SelectQuery]) CCarEntriesQuery {
	...
	return CCarEntries.Query(append(mods,
		sm.Where(CCarEntries.Columns.EventID.EQ(PKArgExpr)),
	)...)
}
...
func (os EventSlice) Tenant(mods ...bob.Mod[*dialect.SelectQuery]) TenantsQuery {
	...
	PKArgExpr := psql.Any(psql.Cast(psql.Arg(pkTenantID), "integer[]"))

	return Tenants.Query(append(mods,
		sm.Where(Tenants.Columns.ID.EQ(PKArgExpr)),
	)...)
}
...
func (os EventSlice) Track(mods ...bob.Mod[*dialect.SelectQuery]) TracksQuery {
	...
	PKArgExpr := psql.Any(psql.Cast(psql.Arg(pkTrackID), "integer[]"))

	return Tracks.Query(append(mods,
		sm.Where(Tracks.Columns.ID.EQ(PKArgExpr)),
	)...)
}
...
func (os EventSlice) EventExt(mods ...bob.Mod[*dialect.SelectQuery]) EventExtsQuery {
	...
	return EventExts.Query(append(mods,
		sm.Where(EventExts.Columns.EventID.EQ(PKArgExpr)),
	)...)
}
...
func (os EventSlice) RSInfos(mods ...bob.Mod[*dialect.SelectQuery]) RSInfosQuery {
	...
	return RSInfos.Query(append(mods,
		sm.Where(RSInfos.Columns.EventID.EQ(PKArgExpr)),
	)...)
}
...
func (event0 *Event) InsertAnalysisProto(ctx context.Context, exec bob.Executor, related *AnalysisProtoSetter) error {
	...
	event0.R.Loaded.AnalysisProto = true

	analysisProto1.R.Event = event0
	analysisProto1.R.Loaded.Event = true
...
func (event0 *Event) InsertEventExt(ctx context.Context, exec bob.Executor, related *EventExtSetter) error {
	...
	event0.R.Loaded.EventExt = true

	eventExt1.R.Event = event0
	eventExt1.R.Loaded.Event = true
...
func buildEventWhere[Q psql.Filterable](cols eventColumns) eventWhere[Q] {
	return eventWhere[Q]{
		...
		EventKey:             psql.Where[Q, string](cols.EventKey.Expression),
		Name:                 psql.Where[Q, string](cols.Name.Expression),
		Description:          psql.WhereNull[Q, string](cols.Description.Expression),
		EventTime:            psql.Where[Q, time.Time](cols.EventTime.Expression),
		RaceloggerVersion:    psql.Where[Q, string](cols.RaceloggerVersion.Expression),
		TeamRacing:           psql.Where[Q, bool](cols.TeamRacing.Expression),
		MultiClass:           psql.Where[Q, bool](cols.MultiClass.Expression),
		NumCarTypes:          psql.Where[Q, int32](cols.NumCarTypes.Expression),
		NumCarClasses:        psql.Where[Q, int32](cols.NumCarClasses.Expression),
		IrSessionID:          psql.WhereNull[Q, int32](cols.IrSessionID.Expression),
		TrackID:              psql.Where[Q, int32](cols.TrackID.Expression),
		PitSpeed:             psql.Where[Q, decimal.Decimal](cols.PitSpeed.Expression),
		ReplayMinTimestamp:   psql.Where[Q, time.Time](cols.ReplayMinTimestamp.Expression),
		ReplayMinSessionTime: psql.Where[Q, decimal.Decimal](cols.ReplayMinSessionTime.Expression),
		ReplayMaxSessionTime: psql.Where[Q, decimal.Decimal](cols.ReplayMaxSessionTime.Expression),
		Sessions:             psql.Where[Q, mytypes.EventSessionSlice](cols.Sessions.Expression),
		IrSubSessionID:       psql.Where[Q, int32](cols.IrSubSessionID.Expression),
		TenantID:             psql.Where[Q, int32](cols.TenantID.Expression),
		TireInfos:            psql.WhereNull[Q, mytypes.TireInfoSlice](cols.TireInfos.Expression),
...
// HasAnalysisProto filters parents that have a matching AnalysisProto using a
...
// applied to the subquery (i.e. to AnalysisProtos).
func (w eventWhereR[Q]) HasAnalysisProto(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(AnalysisProtos.NameExpr()),
		sm.Where(AnalysisProtos.Columns.EventID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}

// HasCCars filters parents that have a matching CCars using a
// correlated EXISTS subquery (semi-join). Unlike an INNER JOIN it does not
// multiply parent rows, so no DISTINCT is needed. The optional filters are
// applied to the subquery (i.e. to CCars).
func (w eventWhereR[Q]) HasCCars(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(CCars.NameExpr()),
		sm.Where(CCars.Columns.EventID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}

// HasCCarClasses filters parents that have a matching CCarClasses using a
// correlated EXISTS subquery (semi-join). Unlike an INNER JOIN it does not
// multiply parent rows, so no DISTINCT is needed. The optional filters are
// applied to the subquery (i.e. to CCarClasses).
func (w eventWhereR[Q]) HasCCarClasses(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(CCarClasses.NameExpr()),
		sm.Where(CCarClasses.Columns.EventID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}
...
func (w eventWhereR[Q]) HasCCarEntries(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(CCarEntries.NameExpr()),
		sm.Where(CCarEntries.Columns.EventID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}

// HasTenant filters parents that have a matching Tenant using a
// correlated EXISTS subquery (semi-join). Unlike an INNER JOIN it does not
// multiply parent rows, so no DISTINCT is needed. The optional filters are
// applied to the subquery (i.e. to Tenants).
func (w eventWhereR[Q]) HasTenant(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(Tenants.NameExpr()),
		sm.Where(Tenants.Columns.ID.EQ(w.cols.TenantID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}

// HasTrack filters parents that have a matching Track using a
// correlated EXISTS subquery (semi-join). Unlike an INNER JOIN it does not
// multiply parent rows, so no DISTINCT is needed. The optional filters are
// applied to the subquery (i.e. to Tracks).
func (w eventWhereR[Q]) HasTrack(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(Tracks.NameExpr()),
		sm.Where(Tracks.Columns.ID.EQ(w.cols.TrackID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}

// HasEventExt filters parents that have a matching EventExt using a
// correlated EXISTS subquery (semi-join). Unlike an INNER JOIN it does not
// multiply parent rows, so no DISTINCT is needed. The optional filters are
// applied to the subquery (i.e. to EventExts).
func (w eventWhereR[Q]) HasEventExt(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(EventExts.NameExpr()),
		sm.Where(EventExts.Columns.EventID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}

// HasRSInfos filters parents that have a matching RSInfos using a
// correlated EXISTS subquery (semi-join). Unlike an INNER JOIN it does not
// multiply parent rows, so no DISTINCT is needed. The optional filters are
// applied to the subquery (i.e. to RSInfos).
func (w eventWhereR[Q]) HasRSInfos(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(RSInfos.NameExpr()),
		sm.Where(RSInfos.Columns.EventID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}
...
type eventPreloadBuf struct {
	ID                   null.Val[int32]
	EventKey             null.Val[string]
	Name                 null.Val[string]
	Description          null.Val[string]
	EventTime            null.Val[time.Time]
	RaceloggerVersion    null.Val[string]
	TeamRacing           null.Val[bool]
	MultiClass           null.Val[bool]
	NumCarTypes          null.Val[int32]
	NumCarClasses        null.Val[int32]
	IrSessionID          null.Val[int32]
	TrackID              null.Val[int32]
	PitSpeed             null.Val[decimal.Decimal]
	ReplayMinTimestamp   null.Val[time.Time]
	ReplayMinSessionTime null.Val[decimal.Decimal]
	ReplayMaxSessionTime null.Val[decimal.Decimal]
	Sessions             null.Val[mytypes.EventSessionSlice]
	IrSubSessionID       null.Val[int32]
	TenantID             null.Val[int32]
	TireInfos            null.Val[mytypes.TireInfoSlice]
}
...
func eventScanMapperNullable(prefix string) scan.Mapper[*Event] {
	return func(ctx context.Context, cols []string) (scan.BeforeFunc, func(any) (*Event, error)) {
		...
		for i, col := range cols {
			...
			case "event_key":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.EventKey }})
			case "name":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.Name }})
			case "description":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.Description }})
			case "event_time":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.EventTime }})
			case "racelogger_version":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.RaceloggerVersion }})
			case "team_racing":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.TeamRacing }})
			case "multi_class":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.MultiClass }})
			case "num_car_types":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.NumCarTypes }})
			case "num_car_classes":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.NumCarClasses }})
			case "ir_session_id":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.IrSessionID }})
			case "track_id":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.TrackID }})
			case "pit_speed":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.PitSpeed }})
			case "replay_min_timestamp":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.ReplayMinTimestamp }})
			case "replay_min_session_time":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.ReplayMinSessionTime }})
			case "replay_max_session_time":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.ReplayMaxSessionTime }})
			case "sessions":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.Sessions }})
			case "ir_sub_session_id":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.IrSubSessionID }})
			case "tenant_id":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.TenantID }})
			case "tire_infos":
				targets = append(targets, target{i, func(b *eventPreloadBuf) any { return &b.TireInfos }})
			}
		}
		...
		return func(row *scan.Row) (any, error) {
				...
				if !(buf.ID.IsValue()) &&
					!(buf.EventKey.IsValue()) &&
					!(buf.Name.IsValue()) &&
					!(buf.Description.IsValue()) &&
					!(buf.EventTime.IsValue()) &&
					!(buf.RaceloggerVersion.IsValue()) &&
					!(buf.TeamRacing.IsValue()) &&
					!(buf.MultiClass.IsValue()) &&
					!(buf.NumCarTypes.IsValue()) &&
					!(buf.NumCarClasses.IsValue()) &&
					!(buf.IrSessionID.IsValue()) &&
					!(buf.TrackID.IsValue()) &&
					!(buf.PitSpeed.IsValue()) &&
					!(buf.ReplayMinTimestamp.IsValue()) &&
					!(buf.ReplayMinSessionTime.IsValue()) &&
					!(buf.ReplayMaxSessionTime.IsValue()) &&
					!(buf.Sessions.IsValue()) &&
					!(buf.IrSubSessionID.IsValue()) &&
					!(buf.TenantID.IsValue()) &&
					!(buf.TireInfos.IsValue()) {
					return nil, nil
				}
				...
				if buf.EventKey.IsValue() {
					o.EventKey = buf.EventKey.MustGet()
				}
				if buf.Name.IsValue() {
					o.Name = buf.Name.MustGet()
				}
				o.Description = buf.Description
				if buf.EventTime.IsValue() {
					o.EventTime = buf.EventTime.MustGet()
				}
				if buf.RaceloggerVersion.IsValue() {
					o.RaceloggerVersion = buf.RaceloggerVersion.MustGet()
				}
				if buf.TeamRacing.IsValue() {
					o.TeamRacing = buf.TeamRacing.MustGet()
				}
				if buf.MultiClass.IsValue() {
					o.MultiClass = buf.MultiClass.MustGet()
				}
				if buf.NumCarTypes.IsValue() {
					o.NumCarTypes = buf.NumCarTypes.MustGet()
				}
				if buf.NumCarClasses.IsValue() {
					o.NumCarClasses = buf.NumCarClasses.MustGet()
				}
				o.IrSessionID = buf.IrSessionID
				if buf.TrackID.IsValue() {
					o.TrackID = buf.TrackID.MustGet()
				}
				if buf.PitSpeed.IsValue() {
					o.PitSpeed = buf.PitSpeed.MustGet()
				}
				if buf.ReplayMinTimestamp.IsValue() {
					o.ReplayMinTimestamp = buf.ReplayMinTimestamp.MustGet()
				}
				if buf.ReplayMinSessionTime.IsValue() {
					o.ReplayMinSessionTime = buf.ReplayMinSessionTime.MustGet()
				}
				if buf.ReplayMaxSessionTime.IsValue() {
					o.ReplayMaxSessionTime = buf.ReplayMaxSessionTime.MustGet()
				}
				if buf.Sessions.IsValue() {
					o.Sessions = buf.Sessions.MustGet()
				}
				if buf.IrSubSessionID.IsValue() {
					o.IrSubSessionID = buf.IrSubSessionID.MustGet()
				}
				if buf.TenantID.IsValue() {
					o.TenantID = buf.TenantID.MustGet()
				}
				o.TireInfos = buf.TireInfos
				return o, nil
			}
	}
}
...
func buildEventPreloader() eventPreloader {
	return eventPreloader{
		AnalysisProto: func(opts ...psql.PreloadOption) psql.Preloader {
			...
			}, AnalysisProtos.Columns.Names(), analysisProtoScanMapperNullable, opts...)
		},
		Tenant: func(opts ...psql.PreloadOption) psql.Preloader {
			...
			}, Tenants.Columns.Names(), tenantScanMapperNullable, opts...)
		},
		Track: func(opts ...psql.PreloadOption) psql.Preloader {
			...
			}, Tracks.Columns.Names(), trackScanMapperNullable, opts...)
		},
		EventExt: func(opts ...psql.PreloadOption) psql.Preloader {
			...
			}, EventExts.Columns.Names(), eventExtScanMapperNullable, opts...)
		},
	}
}
...
func (o *Event) LoadAnalysisProto(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	o.R.Loaded.AnalysisProto = false
...
func (os EventSlice) LoadTenant(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	for _, o := range os {
		...
		eventByKey[o.TenantID] = append(eventByKey[o.TenantID], o)
	}
...
func (os EventSlice) LoadTrack(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	for _, o := range os {
		...
		eventByKey[o.TrackID] = append(eventByKey[o.TrackID], o)
	}
...
type eventCountPreloader struct {
	...
	CCarClasses func(...bob.Mod[*dialect.SelectQuery]) psql.Preloader
	CCarEntries func(...bob.Mod[*dialect.SelectQuery]) psql.Preloader
	RSInfos     func(...bob.Mod[*dialect.SelectQuery]) psql.Preloader
}
...
func buildEventCountPreloader() eventCountPreloader {
	return eventCountPreloader{
		CCars: func(mods ...bob.Mod[*dialect.SelectQuery]) psql.Preloader {
			return countPreloader[*Event]("CCars", func(parent string) bob.Expression {
				...
				subqueryMods := []bob.Mod[*dialect.SelectQuery]{
					...
					sm.Where(psql.Quote(CCars.Alias(), "event_id").EQ(psql.Quote(parent, "id"))),
				}
				subqueryMods = append(subqueryMods, mods...)
				return psql.Group(psql.Select(subqueryMods...).Expression)
			})
		},
		CCarClasses: func(mods ...bob.Mod[*dialect.SelectQuery]) psql.Preloader {
			return countPreloader[*Event]("CCarClasses", func(parent string) bob.Expression {
				// Build a correlated subquery: (SELECT COUNT(*) FROM related WHERE fk = parent.pk)
				if parent == "" {
					parent = Events.Alias()
				}
				...
				subqueryMods := []bob.Mod[*dialect.SelectQuery]{
					...
					sm.From(CCarClasses.NameAsExpr()),
					sm.Where(psql.Quote(CCarClasses.Alias(), "event_id").EQ(psql.Quote(parent, "id"))),
				}
				subqueryMods = append(subqueryMods, mods...)
				return psql.Group(psql.Select(subqueryMods...).Expression)
			})
		...
		CCarEntries: func(mods ...bob.Mod[*dialect.SelectQuery]) psql.Preloader {
			return countPreloader[*Event]("CCarEntries", func(parent string) bob.Expression {
				// Build a correlated subquery: (SELECT COUNT(*) FROM related WHERE fk = parent.pk)
				if parent == "" {
					parent = Events.Alias()
				}
				...
				subqueryMods := []bob.Mod[*dialect.SelectQuery]{
					...
					sm.Where(psql.Quote(CCarEntries.Alias(), "event_id").EQ(psql.Quote(parent, "id"))),
				}
				subqueryMods = append(subqueryMods, mods...)
				return psql.Group(psql.Select(subqueryMods...).Expression)
			})
		},
		RSInfos: func(mods ...bob.Mod[*dialect.SelectQuery]) psql.Preloader {
			return countPreloader[*Event]("RSInfos", func(parent string) bob.Expression {
				// Build a correlated subquery: (SELECT COUNT(*) FROM related WHERE fk = parent.pk)
				if parent == "" {
					parent = Events.Alias()
				}
				...
				subqueryMods := []bob.Mod[*dialect.SelectQuery]{
					...
					sm.From(RSInfos.NameAsExpr()),
					sm.Where(psql.Quote(RSInfos.Alias(), "event_id").EQ(psql.Quote(parent, "id"))),
				}
				subqueryMods = append(subqueryMods, mods...)
				return psql.Group(psql.Select(subqueryMods...).Expression)
			})
...
func buildEventCountThenLoader[Q orm.Loadable]() eventCountThenLoader[Q] {
	...
	type CCarClassesCountInterface interface {
		LoadCountCCarClasses(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}
	...
	type RSInfosCountInterface interface {
		LoadCountRSInfos(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}
	...
	return eventCountThenLoader[Q]{
		...
		CCarClasses: countThenLoadBuilder[Q](
			"CCarClasses",
			func(ctx context.Context, exec bob.Executor, retrieved CCarClassesCountInterface, mods ...bob.Mod[*dialect.SelectQuery]) error {
				return retrieved.LoadCountCCarClasses(ctx, exec, mods...)
			},
		),
		...
		RSInfos: countThenLoadBuilder[Q](
			"RSInfos",
			func(ctx context.Context, exec bob.Executor, retrieved RSInfosCountInterface, mods ...bob.Mod[*dialect.SelectQuery]) error {
				return retrieved.LoadCountRSInfos(ctx, exec, mods...)
			},
		),
	}
}
...
func (o *Event) LoadCountCCars(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if o == nil {
		return nil
	}
...
func (os EventSlice) LoadCountCCars(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if len(os) == 0 {
		return nil
	}
	...
	batchMods := []bob.Mod[*dialect.SelectQuery]{
		...
		sm.Where(CCars.Columns.EventID.EQ(PKArgExpr)),
		// GROUP BY fk columns
		sm.GroupBy(CCars.Columns.EventID),
	}
...
// LoadCountCCarClasses loads the count of CCarClasses into the C struct
func (o *Event) LoadCountCCarClasses(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if o == nil {
		return nil
	}

	count, err := o.CCarClasses(mods...).Count(ctx, exec)
	if err != nil {
		return err
	}
...
// LoadCountCCarClasses loads the count of CCarClasses for a slice in a single batch query
func (os EventSlice) LoadCountCCarClasses(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if len(os) == 0 {
		return nil
	}
	...
	batchMods := []bob.Mod[*dialect.SelectQuery]{
		// SELECT fk AS parent_pk, count(*)
		sm.Columns(
			CCarClasses.Columns.EventID.As("id"),
			psql.Raw("count(*) as count"),
		),
		// Single-hop: FROM related table directly
		sm.From(CCarClasses.NameAsExpr()),
		...
		sm.Where(CCarClasses.Columns.EventID.EQ(PKArgExpr)),
		// GROUP BY fk columns
		sm.GroupBy(CCarClasses.Columns.EventID),
	}
	batchMods = append(batchMods, mods...)
...
func (o *Event) LoadCountCCarEntries(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if o == nil {
		return nil
	}
...
func (os EventSlice) LoadCountCCarEntries(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if len(os) == 0 {
		return nil
	}
	...
	batchMods := []bob.Mod[*dialect.SelectQuery]{
		// SELECT fk AS parent_pk, count(*)
		sm.Columns(
			CCarEntries.Columns.EventID.As("id"),
			psql.Raw("count(*) as count"),
		),
		// Single-hop: FROM related table directly
		sm.From(CCarEntries.NameAsExpr()),
		...
		sm.Where(CCarEntries.Columns.EventID.EQ(PKArgExpr)),
		// GROUP BY fk columns
		sm.GroupBy(CCarEntries.Columns.EventID),
	}
	batchMods = append(batchMods, mods...)
...
// LoadCountRSInfos loads the count of RSInfos into the C struct
func (o *Event) LoadCountRSInfos(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if o == nil {
		return nil
	}

	count, err := o.RSInfos(mods...).Count(ctx, exec)
	if err != nil {
		return err
	}
...
// LoadCountRSInfos loads the count of RSInfos for a slice in a single batch query
func (os EventSlice) LoadCountRSInfos(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if len(os) == 0 {
		return nil
	}
	...
	batchMods := []bob.Mod[*dialect.SelectQuery]{
		...
		sm.Where(RSInfos.Columns.EventID.EQ(PKArgExpr)),
		// GROUP BY fk columns
		sm.GroupBy(RSInfos.Columns.EventID),
	}
	batchMods = append(batchMods, mods...)
	...
	return eventJoins[Q]{
		...
		AnalysisProto: modAs[Q, analysisProtoColumns]{
			...
			f: func(to analysisProtoColumns) bob.Mod[Q] {
				...
				{
					mods = append(mods, dialect.Join[Q](typ, AnalysisProtos.NameExpr().As(to.Alias())).On(
		...
		CCarClasses: modAs[Q, cCarClassColumns]{
			...
			f: func(to cCarClassColumns) bob.Mod[Q] {
				...
				{
					mods = append(mods, dialect.Join[Q](typ, CCarClasses.NameExpr().As(to.Alias())).On(
						to.EventID.EQ(cols.ID),
					))
				}
		...
		Tenant: modAs[Q, tenantColumns]{
			...
			f: func(to tenantColumns) bob.Mod[Q] {
				...
				{
					mods = append(mods, dialect.Join[Q](typ, Tenants.NameExpr().As(to.Alias())).On(
		...
		Track: modAs[Q, trackColumns]{
			...
			f: func(to trackColumns) bob.Mod[Q] {
				...
				{
					mods = append(mods, dialect.Join[Q](typ, Tracks.NameExpr().As(to.Alias())).On(
		...
		EventExt: modAs[Q, eventExtColumns]{
			...
			f: func(to eventExtColumns) bob.Mod[Q] {
				...
				{
					mods = append(mods, dialect.Join[Q](typ, EventExts.NameExpr().As(to.Alias())).On(
						to.EventID.EQ(cols.ID),
					))
				}
