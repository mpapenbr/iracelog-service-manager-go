...
var AnalysisProtos = psql.NewTablex[*AnalysisProto, AnalysisProtoSlice, *AnalysisProtoSetter]("", "analysis_proto")
...
type analysisProtoColumnNames struct {
	EventID     string
	RecordStamp string
	Protodata   string
}

var AnalysisProtoColumns = buildAnalysisProtoColumns("analysis_proto")
...
func FindAnalysisProto(ctx context.Context, exec bob.Executor, EventIDPK int32, cols ...string) (*AnalysisProto, error) {
	if len(cols) == 0 {
		return AnalysisProtos.Query(
			SelectWhere.AnalysisProtos.EventID.EQ(EventIDPK),
		).One(ctx, exec)
	}
...
func (o *AnalysisProto) Reload(ctx context.Context, exec bob.Executor) error {
	o2, err := AnalysisProtos.Query(
		SelectWhere.AnalysisProtos.EventID.EQ(o.EventID),
	).One(ctx, exec)
	if err != nil {
		return err
	}
	...
	return analysisProtoPreloader{
		Event: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Event, EventSlice](orm.Relationship{
				...
				Sides: []orm.RelSide{
					{
						From: TableNames.AnalysisProtos,
