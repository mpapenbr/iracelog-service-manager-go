...
var CCars = psql.NewTablex[*CCar, CCarSlice, *CCarSetter]("", "c_car")
...
var CCarColumns = buildCCarColumns("c_car")
...
func (o *CCar) CCarClass(mods ...bob.Mod[*dialect.SelectQuery]) CCarClassesQuery {
	return CCarClasses.Query(append(mods,
		sm.Where(CCarClassColumns.ID.EQ(psql.Arg(o.CCarClassID))),
	)...)
}
...
func (os CCarSlice) CCarClass(mods ...bob.Mod[*dialect.SelectQuery]) CCarClassesQuery {
	...
	return CCarClasses.Query(append(mods,
		sm.Where(psql.Group(CCarClassColumns.ID).OP("IN", PKArgExpr)),
	)...)
}
...
func (o *CCar) CCarEntries(mods ...bob.Mod[*dialect.SelectQuery]) CCarEntriesQuery {
	return CCarEntries.Query(append(mods,
		sm.Where(CCarEntryColumns.CCarID.EQ(psql.Arg(o.ID))),
	)...)
}
...
func (os CCarSlice) CCarEntries(mods ...bob.Mod[*dialect.SelectQuery]) CCarEntriesQuery {
	...
	return CCarEntries.Query(append(mods,
		sm.Where(psql.Group(CCarEntryColumns.CCarID).OP("IN", PKArgExpr)),
	)...)
}
...
func buildCCarPreloader() cCarPreloader {
	return cCarPreloader{
		CCarClass: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*CCarClass, CCarClassSlice](orm.Relationship{
				Name: "CCarClass",
				Sides: []orm.RelSide{
					{
						From: TableNames.CCars,
						To:   TableNames.CCarClasses,
						FromColumns: []string{
							ColumnNames.CCars.CCarClassID,
						},
						ToColumns: []string{
							ColumnNames.CCarClasses.ID,
						},
					},
				},
