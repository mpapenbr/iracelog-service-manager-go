...
type preloadCounts struct {
	CCar      cCarCountPreloader
	CCarClass cCarClassCountPreloader
	CCarEntry cCarEntryCountPreloader
	Event     eventCountPreloader
	RSInfo    rsInfoCountPreloader
	Tenant    tenantCountPreloader
	Track     trackCountPreloader
}

func getPreloadCount() preloadCounts {
	return preloadCounts{
		CCar:      buildCCarCountPreloader(),
		CCarClass: buildCCarClassCountPreloader(),
		CCarEntry: buildCCarEntryCountPreloader(),
		Event:     buildEventCountPreloader(),
		RSInfo:    buildRSInfoCountPreloader(),
		Tenant:    buildTenantCountPreloader(),
		Track:     buildTrackCountPreloader(),
	}
}

type thenLoadCounts[Q orm.Loadable] struct {
	CCar      cCarCountThenLoader[Q]
	CCarClass cCarClassCountThenLoader[Q]
	CCarEntry cCarEntryCountThenLoader[Q]
	Event     eventCountThenLoader[Q]
	RSInfo    rsInfoCountThenLoader[Q]
	Tenant    tenantCountThenLoader[Q]
	Track     trackCountThenLoader[Q]
}

func getThenLoadCount[Q orm.Loadable]() thenLoadCounts[Q] {
	return thenLoadCounts[Q]{
		CCar:      buildCCarCountThenLoader[Q](),
		CCarClass: buildCCarClassCountThenLoader[Q](),
		CCarEntry: buildCCarEntryCountThenLoader[Q](),
		Event:     buildEventCountThenLoader[Q](),
		RSInfo:    buildRSInfoCountThenLoader[Q](),
		Tenant:    buildTenantCountThenLoader[Q](),
		Track:     buildTrackCountThenLoader[Q](),
	}
}
