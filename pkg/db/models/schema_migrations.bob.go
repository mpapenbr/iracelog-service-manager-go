...
func (o *SchemaMigration) pkEQ() dialect.Expression {
	return psql.Quote("schema_migrations", "version").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
...
func (o SchemaMigrationSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("schema_migrations", "version").In(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
