...
var CCarClasses = psql.NewTablex[*CCarClass, CCarClassSlice, *CCarClassSetter]("", "c_car_class")
...
type cCarClassColumnNames struct {
	ID         string
	EventID    string
	Name       string
	CarClassID string
...
var CCarClassColumns = buildCCarClassColumns("c_car_class")
...
func FindCCarClass(ctx context.Context, exec bob.Executor, IDPK int32, cols ...string) (*CCarClass, error) {
	if len(cols) == 0 {
		return CCarClasses.Query(
			SelectWhere.CCarClasses.ID.EQ(IDPK),
		).One(ctx, exec)
	}
...
func (o *CCarClass) Reload(ctx context.Context, exec bob.Executor) error {
	o2, err := CCarClasses.Query(
		SelectWhere.CCarClasses.ID.EQ(o.ID),
	).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o *CCarClass) CCars(mods ...bob.Mod[*dialect.SelectQuery]) CCarsQuery {
	return CCars.Query(append(mods,
		sm.Where(CCarColumns.CCarClassID.EQ(psql.Arg(o.ID))),
	)...)
}
...
func (os CCarClassSlice) CCars(mods ...bob.Mod[*dialect.SelectQuery]) CCarsQuery {
	...
	return CCars.Query(append(mods,
		sm.Where(psql.Group(CCarColumns.CCarClassID).OP("IN", PKArgExpr)),
	)...)
}
	...
	return cCarClassPreloader{
		Event: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Event, EventSlice](orm.Relationship{
				...
				Sides: []orm.RelSide{
					{
						From: TableNames.CCarClasses,
						To:   TableNames.Events,
						FromColumns: []string{
							ColumnNames.CCarClasses.EventID,
						},
						ToColumns: []string{
